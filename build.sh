...
rm -rf dist/esm/extract/public # purge empty declaration files that only contained interface definitions
rm -rf dist/esm/extract/private
...
rm -rf dist/cjs/extract/public # purge empty declaration files that only contained interface definitions
rm -rf dist/cjs/extract/private
