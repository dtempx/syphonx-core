...
describe("combineUrl", () => {
    ...
    it("9", () => expect(combineUrl("https://www.example.com/index.html", "/logo.png?version=1")).equals("https://www.example.com/logo.png?version=1"));
    it("10", () => expect(combineUrl("https://www.example.com/index.html", "/logo.png#fragment")).equals("https://www.example.com/logo.png#fragment"));
    it("11", () => expect(combineUrl("https://www.example.com", "/logo with spaces")).equals("https://www.example.com/logo%20with%20spaces"));
    it("12", () => expect(combineUrl("", "logo")).equals("logo"));
    it("13", () => expect(combineUrl(null!, "logo")).equals("logo"));
    it("14", () => expect(combineUrl(undefined!, "logo")).equals("logo"));
    it("15", () => expect(combineUrl("https://www.example.com", "")).equals("https://www.example.com"));
    ...
    it("18", () => expect(combineUrl(undefined!, undefined!)).equals(undefined));
    ...
    it("26", () => expect(combineUrl("http://www.example.com/", "//www.iana.org/domains/reserved")).equals("http://www.iana.org/domains/reserved"));
});
