...
**Categories:**
- **Data extraction:** [SelectAction](modules.md#selectaction), [TransformAction](modules.md#transformaction)
- **Control flow:** [RepeatAction](modules.md#repeataction), [EachAction](modules.md#eachaction), [SwitchAction](modules.md#switchaction), [BreakAction](modules.md#breakaction)
- **Browser interaction:** [ClickAction](modules.md#clickaction), [ScrollAction](modules.md#scrollaction), [KeyPressAction](modules.md#keypressaction), [LocatorAction](modules.md#locatoraction)
- **Navigation:** [NavigateAction](modules.md#navigateaction), [GoBackAction](modules.md#gobackaction), [ReloadAction](modules.md#reloadaction)
- **Timing / async:** [SnoozeAction](modules.md#snoozeaction), [WaitForAction](modules.md#waitforaction), [YieldAction](modules.md#yieldaction)
- **Diagnostics:** [ErrorAction](modules.md#erroraction), [ScreenshotAction](modules.md#screenshotaction)
...
[Action](modules.md#action) union (e.g. `"select"`, `"click"`, `"repeat"`).
...
Conditionally exits the enclosing [repeat](modules.md#repeataction) or
[each](modules.md#eachaction) loop. Online-only — bypassed in offline mode.
...
- `[min, max, mode]` — same, but explicitly sets when the pause occurs
  relative to the action (see [SnoozeMode](modules.md#snoozemode)).
...
[SnoozeInterval](modules.md#snoozeinterval) on actions like [Click](interfaces/Click.md) that support
...
only `select` and `transform` action types. Unlike [extract](modules.md#extract), this function
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `actions` | [`Action`](modules.md#action)[] | The top-level actions array to search. |
| `action_type` | [`ActionType`](modules.md#actiontype) | The action type key to filter by (e.g. `"select"`, `"click"`). |

#### Returns

[`Action`](modules.md#action)[]

An array of matching [Action](modules.md#action) objects.
...
| :------ | :------ | :------ | :------ |
| `actions` | [`Action`](modules.md#action)[] | `undefined` | The actions array to flatten. |
