...
The `snooze` action also accepts shorthand forms via [SnoozeAction](../README.md#snoozeaction):
...
a pause before/after a click — see [SnoozeInterval](../README.md#snoozeinterval) and
[SnoozeMode](../README.md#snoozemode) for that usage.
...
the skipped-steps metric is incremented. See [When](../README.md#when) for expression
syntax details.
